								...
								<div id="navMenuLevelThreeOne1" class="collapse " data-bs-parent="#navMenuLevel">
									<ul class="nav flex-column">
										<li class="nav-item">
											...
											<div id="navMenuLevelThreeTwo" class="collapse " data-bs-parent="#navMenuLevelThree">
												<ul class="nav flex-column">
													<li class="nav-item">
...
<nav class="navbar-vertical-nav offcanvas offcanvas-start navbar-offcanvac" tabindex="-1" id="offcanvasExample">
							...
							<div id="navMenuLevelThree2" class="collapse " data-bs-parent="#navMenuLevel">
								<ul class="nav flex-column">
									<li class="nav-item">
										...
										<div id="navMenuLevelThree3" class="collapse  " data-bs-parent="#navMenuLevelThree">
											<ul class="nav flex-column">
												<li class="nav-item">
													<a class="nav-link " href="#">NavChild Item 1</a>
												</li>
 ...
 {{-- Nouveau sidebar menu dynamique --}}
            ...
            <div class="navbar-vertical-content flex-grow-1" data-simplebar="">
                <ul class="navbar-nav flex-column" id="sideNavbar">
                    ...
                    @if($user->role === 'admin')
                        ...
                        <li class="nav-item">
                            <a class="nav-link {{ request()->routeIs('admin.option-personnalisations.*') ? 'active' : '' }}" href="{{ route('admin.users.index') }}">
                                <div class="d-flex align-items-center">
                                    <span class="nav-link-icon"><i class="bi bi-people"></i></span>
                        ...
                        <li class="nav-item">
                            <a class="nav-link {{ request()->routeIs('admin.echantillons.*') ? 'active' : '' }}" href="{{ route('admin.users.index') }}">
                                <div class="d-flex align-items-center">
                                    <span class="nav-link-icon"><i class="bi bi-people"></i></span>
