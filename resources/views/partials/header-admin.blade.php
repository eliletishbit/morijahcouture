		...
		<div class="d-flex justify-content-between align-items-center w-100">
			...
			<div>
				<ul class="list-unstyled d-flex align-items-center mb-0 ms-5 ms-lg-0">
					{{-- logic deconnexion backend dash --}}
					<li>
					<a class="text-muted position-relative" data-bs-toggle="offcanvas" data-bs-target="#offcanvasRight" href="#offcanvasExample" role="button" aria-controls="offcanvasRight">
						@auth
							<a style="position:relative, right:120px;" href="#" onclick="event.preventDefault(); document.getElementById('logout-form').submit();" title="Déconnexion">
							<i class="fa fa-power-offfa fa-power-off"></i>
							</a>
