{{-- resources/views/layouts/livewirecustomizationeditor.blade.php --}}
<!doctype html>
...
<body>
    {{-- UN SEUL ÉLÉMENT RACINE QUI CONTIENT TOUT --}}
    <div>
        <div id="app">
        ...
        <!-- Bouton retour en haut - MAINTENANT À L'INTÉRIEUR du div racine -->
